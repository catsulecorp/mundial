...
export const CARDS: Card[] = [
  ...
  { id: 'dembele', name: 'DEMBÉLÉ', power: 6, env: 7, country: 'Francia', club: 'PSG', image: '/stickers/france/figu-de-dembele.png', stickerNumber: 'FRA 7' },
  { id: 'enzo', name: 'ENZO F.', power: 7, env: 8, country: 'Argentina', club: 'Chelsea', image: '/stickers/argentina/figu-de-enzo-fernandez.png', stickerNumber: 'ARG 5' },
  ...
  { id: 'simeone', name: 'SIMEONE', power: 13, env: 17, country: 'Argentina', club: 'Atlético Madrid', image: '/stickers/argentina/figu-de-giuliano-simeone.png', stickerNumber: 'ARG 10' },
  ...
  { id: 'upamecano', name: 'UPAMECANO', power: 15, env: 4, country: 'Francia', club: 'Bayern Munich', image: '/stickers/france/figu-de-upamecano.png', stickerNumber: 'FRA 4' },
  { id: 'saliba', name: 'SALIBA', power: 16, env: 17, country: 'Francia', club: 'Arsenal', image: '/stickers/france/figu-de-saliba.png', stickerNumber: 'FRA 2' },
  ...
  { id: 'doue', name: 'DÉSIRÉ DOUÉ', power: 21, env: 12, country: 'Francia', club: 'PSG', image: '/stickers/france/figu-de-doue.png', stickerNumber: 'FRA 10' },
  { id: 'ekitike', name: 'HUGO EKITIKÉ', power: 22, env: 9, country: 'Francia', club: 'Eintracht Frankfurt', image: '/stickers/france/figu-de-ekitike.png', stickerNumber: 'FRA 11' },
];
